...
> Compatible with [vercel-labs/skills](https://github.com/vercel-labs/skills). Works with 54+ agents including Claude Code, Cursor, Cline, Codex, and more.

```bash
# Install all skills into your project
npx skills add xblaster/instill-skills

# Install globally (available across all projects)
npx skills add xblaster/instill-skills --global

# Install specific skills only
npx skills add xblaster/instill-skills --skill git-master --skill dependency-sentinel

# Target a specific agent
npx skills add xblaster/instill-skills --agent claude-code

# List available skills without installing
npx skills add xblaster/instill-skills --list
```

### Via `instill`

```bash
# Add this repo as a remote source
...
* **[Dependency Sentinel](skills/dependency-sentinel/SKILL.md)** (`dependency-sentinel`)
...
* **[Security Audit](skills/security-audit/SKILL.md)** (`security-audit-tool`)
...
* **[Debug Stacktrace Resolver](skills/debug-stacktrace-resolver/SKILL.md)** (`debug-stacktrace-resolver`)
...
* **[Architect Vision Audit](skills/architect-vision-audit/SKILL.md)** (`architect-vision-audit`)
...
* **[Tech Debt Loan Officer](skills/tech-debt-loan-officer/SKILL.md)** (`tech-debt-loan-officer`)
...
* **[Git Master](skills/git-master/SKILL.md)** (`git-master`)
...
* **[Generate Dockerfile](skills/generate-dockerfile/SKILL.md)** (`generate-dockerfile`)
...
* **[Auto-Doc Manager](skills/auto-doc-manager/SKILL.md)** (`auto-doc-manager`)
...
* **[Improbable Recruiter](skills/improbable-recruiter/SKILL.md)** (`improbable-recruiter`)
  * *The Talent Scout.* Identifies the "Black Swan" hire. It analyzes your codebase's "Technical DNA" to generate a job description for an atypical profile who would bring disruptive innovation.

### 🚀 Growth & Community

* **[OSS Community Catalyst](skills/oss-community-catalyst/SKILL.md)** (`oss-community-catalyst`)
...
```text
skills/
├── architect-vision-audit/
│   └── SKILL.md        # Architectural alignment & CTO-level oversight
├── auto-doc-manager/
│   └── SKILL.md        # Documentation synchronization
├── debug-stacktrace-resolver/
│   └── SKILL.md        # Error analysis & resolution
├── dependency-sentinel/
│   └── SKILL.md        # Vulnerability auditing & remediation
├── generate-dockerfile/
│   └── SKILL.md        # Tech stack detection & Dockerization
├── git-master/
│   └── SKILL.md        # Advanced Git workflows & PR management
├── improbable-recruiter/
│   └── SKILL.md        # Strategic hiring & cognitive diversity analysis
├── oss-community-catalyst/
│   └── SKILL.md        # Community engagement & OSS growth
├── security-audit/
│   └── SKILL.md        # Comprehensive security scanning
└── tech-debt-loan-officer/
    └── SKILL.md        # Technical debt & complexity analysis
```

Each `SKILL.md` uses YAML frontmatter (`name`, `description`) for discovery by `npx skills` and compatible agents.
...
2. Add a `SKILL.md` file with the required frontmatter:
   ...
   ---
   ```
3. Define the `input`, `steps` (the "thought process"), and `output`. Use our [Template Skill](.instill/library/template-skill.md) as a starting point.
4. Open a PR!
